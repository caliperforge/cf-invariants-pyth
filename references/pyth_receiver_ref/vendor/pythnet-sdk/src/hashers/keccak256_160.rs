// CF-PORT: 1:1 vendor of pythnet/pythnet_sdk/src/hashers/keccak256_160.rs.
// CF-PORT: upstream uses `solana_program::keccak::hashv`; under anchor-lang 1.0.1 the modular
//   replacement is `solana_keccak_hasher::hashv` (identical API). The crate-name swap is the only
//   deviation.
